module.exports = function(THREE) {
  ...
  ThreeBSP.prototype.toTree = function(treeIsh) {
    ...
    var _this = this, polygons = [], geometry = treeIsh === THREE.BufferGeometry ? treeIsh : treeIsh.constructor === THREE.Mesh ? (treeIsh.updateMatrix(), this.matrix = treeIsh.matrix.clone(), treeIsh.geometry) : void 0;
    var attributes = geometry.attributes, normal = attributes.normal, position = attributes.position, uv = attributes.uv;
    var pointsArr = [], normalsArr = [], uvsArr = [], pointsLength = attributes.position.array.length/attributes.position.itemSize;
  ...
  ThreeBSP.Vertex = (function(_super) {
    ...
    function Vertex(x, y, z, normal, uv) {
      ...
      // 此方法调用父级THREE.Vector3构造函数会报错，因此弃用
