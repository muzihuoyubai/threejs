module.exports = function(THREE) {
  ...
  ThreeBSP.prototype.toTree = function(treeIsh) {
    ...
    var polygons = [], geometry = treeIsh === THREE.BufferGeometry ? treeIsh : treeIsh.constructor === THREE.Mesh ? (treeIsh.updateMatrix(), this.matrix = treeIsh.matrix.clone(), treeIsh.geometry) : void 0;
