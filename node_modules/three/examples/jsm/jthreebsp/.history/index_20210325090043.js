module.exports = function(THREE) {
   ...
   * 转换成mesh
   * @param {*} material 材质
   * @param {*} groupByCoplanar 是否根据共面进行分组
   * @returns 
   */
  ThreeBSP.prototype.toMesh = function(material, groupByCoplanar) {
    var geometry = this.toGeometry(groupByCoplanar);
    if (material == null) {
  ...
  /**
   * 转换成图形
   * @param {*} groupByCoplanar 
   * @returns 
   */
  ThreeBSP.prototype.toGeometry = function(groupByCoplanar) {
